...
document.body.innerHTML += `Qual o primeiro indice da letra A no seu nome? ${nome.indexOf(
  "a"
)} <br/ >`;
document.body.innerHTML += `Qual o ultimo indice da letra A no seu nome? ${nome.lastIndexOf(
  "a"
)} <br/ >`;
document.body.innerHTML += `As últmas 3 letras do seu nome são: ${nome.slice(
  -3
)} <br/ >`;
